...
RUN_TAG="${RUN_TAG:-v244_prototype_dynamics_12tasks_${BATCH_STAMP}}"
...
# v2.4.4: whole-trajectory prototype structure.
...
export SOURCE_STRUCTURE_LOSS_VERSION="${SOURCE_STRUCTURE_LOSS_VERSION:-trajectory_prototype_dynamics}"
export SOURCE_STRUCTURE_INTRA_TRADE_OFF="${SOURCE_STRUCTURE_INTRA_TRADE_OFF:-5.0}"
export SOURCE_STRUCTURE_PROTOTYPE_DYNAMICS_TRADE_OFF="${SOURCE_STRUCTURE_PROTOTYPE_DYNAMICS_TRADE_OFF:-0.05}"
...
run_source_block() {
  ...
  job_tag="v244_${source_name}_${BATCH_STAMP}"
  ...
  (
    CUDA_VISIBLE_DEVICES="$gpu_id" \
      ...
      VARIANT_NAME="v244_prototype_dynamics" \
...
echo "All v2.4.4 prototype-dynamics 12-task jobs finished."
echo "Logs saved under: $LOG_DIR"
