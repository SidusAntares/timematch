...
export RUN_TAG="${RUN_TAG:-v252_component_controller_12tasks}"
export ANALYSIS_SUBDIR="${ANALYSIS_SUBDIR:-${RUN_TAG}_analysis}"
export RUN_SUFFIX="${RUN_SUFFIX:-runA}"
export RESHAPER_TAG="${RESHAPER_TAG:-v252_component_controller_s010_rel003_${RUN_SUFFIX}}"
...
export SOURCE_COMPONENT_CONTROLLER_DECAY="${SOURCE_COMPONENT_CONTROLLER_DECAY:-0.80}"
export SOURCE_COMPONENT_CONTROLLER_MIN_FACTOR="${SOURCE_COMPONENT_CONTROLLER_MIN_FACTOR:-0.20}"
