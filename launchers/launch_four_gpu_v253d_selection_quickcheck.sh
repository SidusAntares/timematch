...
RUN_TAG="${RUN_TAG:-v253d_latefilter_selection_quickcheck}"
LOG_DIR="${LOG_DIR:-$ROOT_DIR/logs/${RUN_TAG}_$(date +%Y%m%d_%H%M%S)}"

mkdir -p "$LOG_DIR"

export DATA_ROOT="${DATA_ROOT:-/data/user/DBL/timematch_data}"
export RESHAPER_TAG="${RESHAPER_TAG:-v253d_latefilter_s010_rel003}"
...
export SELECTION_SCORE_MODE="${SELECTION_SCORE_MODE:-temporal_perturbation_late_filter}"
...
run_one 0 "denmark/32VNH/2017" "austria/33UVP/2017"
run_one 1 "austria/33UVP/2017" "denmark/32VNH/2017"
run_one 2 "france/30TXT/2017" "france/31TCJ/2017"
run_one 3 "france/31TCJ/2017" "denmark/32VNH/2017"

wait

echo "Logs saved to: $LOG_DIR"
echo "v2.5.3d late-filter selection quickcheck logs:"
echo "  $LOG_DIR/gpu0_32VNH_to_33UVP_${RUN_TAG}.log"
echo "  $LOG_DIR/gpu1_33UVP_to_32VNH_${RUN_TAG}.log"
echo "  $LOG_DIR/gpu2_30TXT_to_31TCJ_${RUN_TAG}.log"
echo "  $LOG_DIR/gpu3_31TCJ_to_32VNH_${RUN_TAG}.log"
