...
RUN_TAG="${RUN_TAG:-structure_component_short_probe_${BATCH_STAMP}}"
...
# Default short probe: one strong segmented-gain task.
# Override TASK_SPECS to probe another pair.
TASK_SPECS="${TASK_SPECS:-FR2_to_FR1|france/31TCJ/2017|france/30TXT/2017}"
...
echo "Short structure-component probe finished."
echo "Logs saved under: $LOG_DIR"
