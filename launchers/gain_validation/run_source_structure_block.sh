...
SOURCE_STRUCTURE_TRAJECTORY_POOLING="${SOURCE_STRUCTURE_TRAJECTORY_POOLING:-meanmax}"
SOURCE_STRUCTURE_PROTOTYPE_DYNAMICS_MODE="${SOURCE_STRUCTURE_PROTOTYPE_DYNAMICS_MODE:-cosine}"
SOURCE_STRUCTURE_ELASTIC_COMPACTNESS="${SOURCE_STRUCTURE_ELASTIC_COMPACTNESS:-False}"
SOURCE_STRUCTURE_ELASTIC_RADIUS="${SOURCE_STRUCTURE_ELASTIC_RADIUS:-0}"
SOURCE_STRUCTURE_ELASTIC_TEMPERATURE="${SOURCE_STRUCTURE_ELASTIC_TEMPERATURE:-0.10}"
SOURCE_STRUCTURE_ELASTIC_BLEND="${SOURCE_STRUCTURE_ELASTIC_BLEND:-1.00}"
SOURCE_STRUCTURE_BASIS_GLOBAL_TRADE_OFF="${SOURCE_STRUCTURE_BASIS_GLOBAL_TRADE_OFF:-0.0}"
SOURCE_STRUCTURE_BASIS_SEGMENT_TRADE_OFF="${SOURCE_STRUCTURE_BASIS_SEGMENT_TRADE_OFF:-1.0}"
SOURCE_STRUCTURE_BASIS_TREND_TRADE_OFF="${SOURCE_STRUCTURE_BASIS_TREND_TRADE_OFF:-0.05}"
SOURCE_STRUCTURE_BASIS_BOUNDARY_TRADE_OFF="${SOURCE_STRUCTURE_BASIS_BOUNDARY_TRADE_OFF:-0.02}"
SOURCE_STRUCTURE_BASIS_DYNAMICS_TRADE_OFF="${SOURCE_STRUCTURE_BASIS_DYNAMICS_TRADE_OFF:-0.05}"
SOURCE_STRUCTURE_BASIS_TRAJECTORY_TRADE_OFF="${SOURCE_STRUCTURE_BASIS_TRAJECTORY_TRADE_OFF:-0.0}"
SOURCE_STRUCTURE_BASIS_ADAPTIVE_SEGMENT_TRADE_OFF="${SOURCE_STRUCTURE_BASIS_ADAPTIVE_SEGMENT_TRADE_OFF:-0.0}"
SOURCE_STRUCTURE_ADAPTIVE_SEGMENT_FILE="${SOURCE_STRUCTURE_ADAPTIVE_SEGMENT_FILE:-}"
SOURCE_STRUCTURE_ADAPTIVE_SEGMENT_MIN_SCORE="${SOURCE_STRUCTURE_ADAPTIVE_SEGMENT_MIN_SCORE:-0.0}"
SOURCE_STRUCTURE_ADAPTIVE_SEGMENT_MIN_RATIO="${SOURCE_STRUCTURE_ADAPTIVE_SEGMENT_MIN_RATIO:-1.0}"
...
echo "V244_WEIGHTS|${VARIANT_NAME}|prototype_dynamics=${SOURCE_STRUCTURE_PROTOTYPE_DYNAMICS_TRADE_OFF}|intra=${SOURCE_STRUCTURE_INTRA_TRADE_OFF}|trajectory_pooling=${SOURCE_STRUCTURE_TRAJECTORY_POOLING}|prototype_dynamics_mode=${SOURCE_STRUCTURE_PROTOTYPE_DYNAMICS_MODE}"
echo "V27_ELASTIC|${VARIANT_NAME}|enabled=${SOURCE_STRUCTURE_ELASTIC_COMPACTNESS}|radius=${SOURCE_STRUCTURE_ELASTIC_RADIUS}|temperature=${SOURCE_STRUCTURE_ELASTIC_TEMPERATURE}|blend=${SOURCE_STRUCTURE_ELASTIC_BLEND}"
echo "V271_BASIS|${VARIANT_NAME}|global=${SOURCE_STRUCTURE_BASIS_GLOBAL_TRADE_OFF}|segment=${SOURCE_STRUCTURE_BASIS_SEGMENT_TRADE_OFF}|trend=${SOURCE_STRUCTURE_BASIS_TREND_TRADE_OFF}|boundary=${SOURCE_STRUCTURE_BASIS_BOUNDARY_TRADE_OFF}|dynamics=${SOURCE_STRUCTURE_BASIS_DYNAMICS_TRADE_OFF}|trajectory=${SOURCE_STRUCTURE_BASIS_TRAJECTORY_TRADE_OFF}|adaptive_segment=${SOURCE_STRUCTURE_BASIS_ADAPTIVE_SEGMENT_TRADE_OFF}"
...
if [ "$SOURCE_SKIP_TRAIN" != "1" ]; then
  python train.py \
    ...
    --source_structure_trajectory_pooling "$SOURCE_STRUCTURE_TRAJECTORY_POOLING" \
    --source_structure_prototype_dynamics_mode "$SOURCE_STRUCTURE_PROTOTYPE_DYNAMICS_MODE" \
    --source_structure_elastic_compactness "$SOURCE_STRUCTURE_ELASTIC_COMPACTNESS" \
    --source_structure_elastic_radius "$SOURCE_STRUCTURE_ELASTIC_RADIUS" \
    --source_structure_elastic_temperature "$SOURCE_STRUCTURE_ELASTIC_TEMPERATURE" \
    --source_structure_elastic_blend "$SOURCE_STRUCTURE_ELASTIC_BLEND" \
    --source_structure_basis_global_trade_off "$SOURCE_STRUCTURE_BASIS_GLOBAL_TRADE_OFF" \
    --source_structure_basis_segment_trade_off "$SOURCE_STRUCTURE_BASIS_SEGMENT_TRADE_OFF" \
    --source_structure_basis_trend_trade_off "$SOURCE_STRUCTURE_BASIS_TREND_TRADE_OFF" \
    --source_structure_basis_boundary_trade_off "$SOURCE_STRUCTURE_BASIS_BOUNDARY_TRADE_OFF" \
    --source_structure_basis_dynamics_trade_off "$SOURCE_STRUCTURE_BASIS_DYNAMICS_TRADE_OFF" \
    --source_structure_basis_trajectory_trade_off "$SOURCE_STRUCTURE_BASIS_TRAJECTORY_TRADE_OFF" \
    --source_structure_basis_adaptive_segment_trade_off "$SOURCE_STRUCTURE_BASIS_ADAPTIVE_SEGMENT_TRADE_OFF" \
    --source_structure_adaptive_segment_file "$SOURCE_STRUCTURE_ADAPTIVE_SEGMENT_FILE" \
    --source_structure_adaptive_segment_min_score "$SOURCE_STRUCTURE_ADAPTIVE_SEGMENT_MIN_SCORE" \
    --source_structure_adaptive_segment_min_ratio "$SOURCE_STRUCTURE_ADAPTIVE_SEGMENT_MIN_RATIO" \
