...
export RUN_TAG="${RUN_TAG:-v242c_semanticaggl_v222}"
export ANALYSIS_SUBDIR="${ANALYSIS_SUBDIR:-${RUN_TAG}_analysis}"
export RESHAPER_TAG="${RESHAPER_TAG:-v242c_semanticaggl_s010_rel003}"
...
export SOURCE_PHASE_PARTITION_MODE="${SOURCE_PHASE_PARTITION_MODE:-semantic_agglomerative}"
...
export SOURCE_SEGMENT_SEMANTIC_QUANTILE="${SOURCE_SEGMENT_SEMANTIC_QUANTILE:-0.85}"
export SOURCE_SEGMENT_SEMANTIC_MAX_SAMPLES_PER_CLASS="${SOURCE_SEGMENT_SEMANTIC_MAX_SAMPLES_PER_CLASS:-128}"
export SOURCE_SEGMENT_SEMANTIC_CURVATURE_TRADE_OFF="${SOURCE_SEGMENT_SEMANTIC_CURVATURE_TRADE_OFF:-0.35}"
export SOURCE_SEGMENT_SEMANTIC_ENERGY_TRADE_OFF="${SOURCE_SEGMENT_SEMANTIC_ENERGY_TRADE_OFF:-0.20}"
export SOURCE_SEGMENT_SEMANTIC_SIMILARITY_TRADE_OFF="${SOURCE_SEGMENT_SEMANTIC_SIMILARITY_TRADE_OFF:-0.20}"
export SOURCE_SEGMENT_SEMANTIC_MAX_EXTRA_CUTS_PER_BASE="${SOURCE_SEGMENT_SEMANTIC_MAX_EXTRA_CUTS_PER_BASE:-1}"
export SOURCE_SEGMENT_SEMANTIC_MERGE_BOUNDARY_TRADE_OFF="${SOURCE_SEGMENT_SEMANTIC_MERGE_BOUNDARY_TRADE_OFF:-0.30}"
export SOURCE_SEGMENT_SEMANTIC_AGGL_MIN_POINTS="${SOURCE_SEGMENT_SEMANTIC_AGGL_MIN_POINTS:-3}"
export SOURCE_SEGMENT_SEMANTIC_AGGL_TARGET_SLACK="${SOURCE_SEGMENT_SEMANTIC_AGGL_TARGET_SLACK:-1}"
export SOURCE_SEGMENT_SEMANTIC_AGGL_MERGE_COST_TOLERANCE="${SOURCE_SEGMENT_SEMANTIC_AGGL_MERGE_COST_TOLERANCE:-1.10}"
export SOURCE_SEGMENT_SEMANTIC_AGGL_DYNAMICS_TRADE_OFF="${SOURCE_SEGMENT_SEMANTIC_AGGL_DYNAMICS_TRADE_OFF:-0.35}"

export SOURCE_STRUCTURE_LOSS_VERSION="${SOURCE_STRUCTURE_LOSS_VERSION:-segment_transition_semantic}"
