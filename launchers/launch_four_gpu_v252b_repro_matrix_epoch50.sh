...
RUN_TAG="${RUN_TAG:-v252b_repro_matrix_epoch50}"
...
run_one() {
  ...
  local reshaper_tag="v252b_boundarywindow_s010_rel003_repro_${source_tile}_to_${target_tile}_${run_suffix}"
