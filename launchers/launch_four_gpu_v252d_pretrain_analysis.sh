...
export RUN_TAG="${RUN_TAG:-v252d_pretrain_analysis}"
export ANALYSIS_SUBDIR="${ANALYSIS_SUBDIR:-${RUN_TAG}_analysis}"
export RUN_SUFFIX="${RUN_SUFFIX:-runA}"
export RESHAPER_TAG="${RESHAPER_TAG:-v252d_s010_rel003_${RUN_SUFFIX}}"
...
# v2.5.2d: pretraining data analysis (replaces gate + controller)
export SOURCE_PRETRAIN_DATA_ANALYSIS_ENABLE="${SOURCE_PRETRAIN_DATA_ANALYSIS_ENABLE:-True}"
export SOURCE_PRETRAIN_ANALYSIS_BATCHES="${SOURCE_PRETRAIN_ANALYSIS_BATCHES:-100}"

# Gate and controller are explicitly disabled (overridden by data analysis)
export SOURCE_COMPONENT_GATE_ENABLE="${SOURCE_COMPONENT_GATE_ENABLE:-False}"
export SOURCE_COMPONENT_CONTROLLER_ENABLE="${SOURCE_COMPONENT_CONTROLLER_ENABLE:-False}"
