...
TIMEMATCH_SOURCE_STRUCTURE_INTRA_TRADE_OFF="${TIMEMATCH_SOURCE_STRUCTURE_INTRA_TRADE_OFF:-$SOURCE_STRUCTURE_INTRA_TRADE_OFF}"
TIMEMATCH_SOURCE_STRUCTURE_TREND_TRADE_OFF="${TIMEMATCH_SOURCE_STRUCTURE_TREND_TRADE_OFF:-$SOURCE_STRUCTURE_TREND_TRADE_OFF}"
...
while IFS= read -r TARGET; do
  ...
  python train.py \
    ...
    --source_structure_interphase_trade_off "$SOURCE_STRUCTURE_INTERPHASE_TRADE_OFF" \
    --source_structure_shape_trade_off "$SOURCE_STRUCTURE_SHAPE_TRADE_OFF" \
    --source_structure_trend_trade_off "$TIMEMATCH_SOURCE_STRUCTURE_TREND_TRADE_OFF" \
    --source_structure_season_trade_off "$SOURCE_STRUCTURE_SEASON_TRADE_OFF" \
