...
RESHAPER_TAG="${RESHAPER_TAG:-v251_boundarywindow_s010_rel003_select}"
SOURCE_MODEL_TAG="${SOURCE_MODEL_TAG:-$RESHAPER_TAG}"
...
SELECTION_COVERAGE_WEIGHT="${SELECTION_COVERAGE_WEIGHT:-1.0}"
SELECTION_ENTROPY_WEIGHT="${SELECTION_ENTROPY_WEIGHT:-0.5}"
SELECTION_AGREEMENT_WEIGHT="${SELECTION_AGREEMENT_WEIGHT:-0.5}"
SELECTION_CONFIDENCE_WEIGHT="${SELECTION_CONFIDENCE_WEIGHT:-0.5}"
