...
RUN_TAG="${RUN_TAG:-v253b_temporalperturb_selection_12tasks}"
...
export RESHAPER_TAG="${RESHAPER_TAG:-v253b_temporalperturb_s010_rel003}"
...
echo "v2.5.3b 12-task temporal perturbation selection logs:"
