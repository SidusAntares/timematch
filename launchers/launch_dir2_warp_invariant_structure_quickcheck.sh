...
export SOURCE_STRUCTURE_LOSS_VERSION="${SOURCE_STRUCTURE_LOSS_VERSION:-segment_boundary_window_warp_residual}"
...
export SOURCE_MODEL_TAG="${SOURCE_MODEL_TAG:-dir2_warp_invariant_s010_rel003_ckptbank}"
export RESHAPER_TAG="${RESHAPER_TAG:-dir2_warp_invariant_allckpt_s010_rel003}"
