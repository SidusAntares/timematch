...
export RUN_TAG="${RUN_TAG:-v242_semanticsegment_v222}"
export ANALYSIS_SUBDIR="${ANALYSIS_SUBDIR:-${RUN_TAG}_analysis}"
export RESHAPER_TAG="${RESHAPER_TAG:-v242_semanticsegment_s010_rel003}"
...
export SOURCE_PHASE_PARTITION_MODE="${SOURCE_PHASE_PARTITION_MODE:-semantic_doy_gap}"
