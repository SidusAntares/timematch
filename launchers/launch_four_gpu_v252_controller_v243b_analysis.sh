...
export RUN_TAG="${RUN_TAG:-v252_controller_v243b_${RUN_SUFFIX}}"
export ANALYSIS_SUBDIR="${ANALYSIS_SUBDIR:-${RUN_TAG}_analysis}"
export RESHAPER_TAG="${RESHAPER_TAG:-v252_controller_boundarywindow_s010_rel003_${RUN_SUFFIX}}"
...
export SOURCE_STRUCTURE_CONTROLLER_WARMUP_EPOCHS="${SOURCE_STRUCTURE_CONTROLLER_WARMUP_EPOCHS:-30}"
export SOURCE_STRUCTURE_CONTROLLER_TARGET_PATIENCE="${SOURCE_STRUCTURE_CONTROLLER_TARGET_PATIENCE:-3}"
...
export SOURCE_STRUCTURE_CONTROLLER_DECAY="${SOURCE_STRUCTURE_CONTROLLER_DECAY:-0.5}"
export SOURCE_STRUCTURE_CONTROLLER_MIN_FACTOR="${SOURCE_STRUCTURE_CONTROLLER_MIN_FACTOR:-0.0}"
export SOURCE_STRUCTURE_CONTROLLER_STOP_THRESHOLD="${SOURCE_STRUCTURE_CONTROLLER_STOP_THRESHOLD:-0.10}"
