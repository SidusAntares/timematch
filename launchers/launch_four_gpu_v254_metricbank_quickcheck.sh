...
export SELECTION_SCORE_MODE="${SELECTION_SCORE_MODE:-temporal_perturbation_trajectory}"
export SELECTION_STRATEGY="${SELECTION_STRATEGY:-metric_bank_rank}"
...
run_pair 0 "france/31TCJ/2017" "denmark/32VNH/2017"
run_pair 1 "denmark/32VNH/2017" "austria/33UVP/2017"
run_pair 2 "austria/33UVP/2017" "denmark/32VNH/2017"
run_pair 3 "france/30TXT/2017" "austria/33UVP/2017"

wait

echo "Logs saved to: $LOG_DIR"
echo "v2.5.4 metric-bank quickcheck selection-only logs:"
echo "  $LOG_DIR/gpu0_31TCJ_to_32VNH_${RUN_TAG}.log"
echo "  $LOG_DIR/gpu1_32VNH_to_33UVP_${RUN_TAG}.log"
echo "  $LOG_DIR/gpu2_33UVP_to_32VNH_${RUN_TAG}.log"
echo "  $LOG_DIR/gpu3_30TXT_to_33UVP_${RUN_TAG}.log"
