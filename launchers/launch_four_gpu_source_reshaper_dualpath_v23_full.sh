...
SOURCE_COMPONENT_ALPHA_TEMPERATURE="${SOURCE_COMPONENT_ALPHA_TEMPERATURE:-0.75}"
SOURCE_COMPONENT_ALPHA_FLOOR="${SOURCE_COMPONENT_ALPHA_FLOOR:-0.10}"
SOURCE_COMPONENT_PHASE_SCALE="${SOURCE_COMPONENT_PHASE_SCALE:-0.85}"
RESHAPER_TAG="${RESHAPER_TAG:-v231_componentized_s010_rel003_t075_f010_ps085}"
...
run_task_group() {
  ...
  CUDA_VISIBLE_DEVICES="$gpu_id" \
    ...
    SOURCE_COMPONENT_ALPHA_TEMPERATURE="$SOURCE_COMPONENT_ALPHA_TEMPERATURE" \
    SOURCE_COMPONENT_ALPHA_FLOOR="$SOURCE_COMPONENT_ALPHA_FLOOR" \
    SOURCE_COMPONENT_PHASE_SCALE="$SOURCE_COMPONENT_PHASE_SCALE" \
