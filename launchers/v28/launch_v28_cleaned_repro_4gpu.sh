...
(
  ...
  bash launchers/v28/launch_v28_cleaned_source_train_4gpu.sh
...
(
  ...
  DATA_LOADER_TIMEOUT="${DATA_LOADER_TIMEOUT:-60}" \
  DRY_RUN="${DRY_RUN:-False}" \
  bash launchers/v28/launch_v28_cleaned_da_4gpu.sh
...
echo "REPORT=${ROOT}/analysis/v28_cleaned_code_reproduction_report.md"
